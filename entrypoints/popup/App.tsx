...
const App: React.FC = () => {
    ...
    const [listSaved, setListSaved] = useState<boolean>(false); // New state for list tab feedback
    ...
    const handleToggleActive = () => {
        ...
        chrome.storage.sync.set({isActive: newActiveState}, () => {
            ...
            setListSaved(true);
            setTimeout(() => setListSaved(false), 5000);
        });
    };
    ...
    return (
        <div className="p-4 w-70 bg-gray-900 text-white shadow-lg font-sans">
            ...
            {activeTab === 'lists' && (
                <>
                    ...
                    {isActive && selectedLists.length === 0 && (
                        <p className="text-yellow-400 text-sm mb-4">Warning: Extension is active but no boycott lists
                            are selected.</p>
                    )}
                </>
            )}
            ...
            {activeTab === 'about' && (
                <div>
                    <h2 className="text-md font-medium text-gray-300 mb-2">About BoykotEt</h2>
                    <p className="text-sm">
